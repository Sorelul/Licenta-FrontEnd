...
const Register = () => {
    ...
    useEffect(() => {
        ...
        const match = registrationform.password === registrationform.confirmPassword;
        setValidate({
            ...validate,
            password: result,
        ...
        <div className="flex w-full h-screen">
            ...
            <div className="w-full flex items-center justify-center lg:w-1/2">
                <div className=" w-11/12 max-w-[700px] px-10 py-10 rounded-3xl bg-white border-2 border-gray-100 ">
                    ...
                    <p className="font-medium text-md text-gray-500 mt-4">Welcome! Please enter you details.</p>
                    ...
                    <div className="mt-8">
                        ...
                        <div className="flex flex-col">
                            <label className="text-lg font-medium">
                                Username
                                <span className={validate.username ? "text-emerald-500 ml-2" : "collapse"}>
                        ...
                        <div className="flex flex-col mt-4">
                            <label className="text-lg font-medium">
                                Email
                                <span className={validate.email ? "text-emerald-500 ml-2" : "collapse"}>
                                    <FontAwesomeIcon icon={faCheck} />
                                </span>
                                <span
                                    className={
                                        validate.email || !registrationform.email ? "collapse" : "text-red-500 ml-2"
                                    }
                                >
                                    <FontAwesomeIcon icon={faTimes} />
                                </span>
                        ...
                        <div className="flex flex-col mt-4">
                            <label className="text-lg font-medium inline-block">
                                ...
                                />
                                <span className={validate.password ? "text-emerald-500 ml-2" : "collapse"}>
                                    <FontAwesomeIcon icon={faCheck} />
                                </span>
                                <span
                                    className={
                                ...
                                >
                                    <FontAwesomeIcon data-tooltip-target="tooltip-password" icon={faTimes} />
                                    <div
                                        id="tooltip-password"
                                        role="tooltip"
                        ...
                        <div className="flex flex-col mt-4">
                            <label className="text-lg font-medium inline-block">
                                ...
                                <span
                                    className={
                                        validate.confirmPassword && registrationform.confirmPassword !== ""
