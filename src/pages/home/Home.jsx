        ...
        <div>
                ...
                <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    <div className="mr-auto place-self-center lg:col-span-7">
                        ...
                        <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                            <b>Add any item.</b> Easily share it with others or keep it private.
                        </p>
                        <button
            ...
            <div className="w-full px-8 mx-auto mt-20 space-y-2 shadow lg:max-w-md mb-12">
                <details className="p-4 rounded-lg">
                    <summary className="font-semibold">Can I really add any item I want?</summary>
                    <div className="mt-3">
                ...
                <details className="p-4 rounded-lg">
                    <summary className="font-semibold">Do people have to join Wishy to shop my list?</summary>
                    <div className="mt-3">
                        <p className="text-sm leading-6 text-gray-600">
                            No, others can shop your list without an account. Set your list to public privacy and share
                            the link. Optionally, if you create a group and invite others, list sharing is automatic
                            without having to send list links.
                        </p>
                    </div>
                </details>
                <details className="p-4 rounded-lg">
                    <summary className="font-semibold">Will I know if someone buys something on my list?</summary>
                    <div className="mt-3">
                        <p className="text-sm leading-6 text-gray-600">
                            Wishy hides the status of items on your own list, to keep the surprise.
                        </p>
                    </div>
                </details>
            </div>
